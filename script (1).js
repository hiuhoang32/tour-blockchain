...
function loadTourDetails(tourId) {
  ...
  const tours = {
    1: {
      ...
      description:
        'Experience the breathtaking beauty of Ha Long Bay, a UNESCO World Heritage Site. Sail through emerald waters, explore limestone caves, and enjoy kayaking and swimming.',
    ...
    2: {
      ...
      description:
        'Discover the charm of Hoi An, a UNESCO World Heritage Site. Explore its historic streets, shop for traditional lanterns, and sample local cuisine.',
    ...
    3: {
      ...
      description:
        'Embark on a memorable trekking adventure in Sapa, a picturesque hill station. Hike through stunning rice terraces, visit local villages, and enjoy breathtaking mountain views.',
    ...
    4: {
      ...
      description:
        'Step back in time in Hue, the ancient capital of Vietnam. Explore the magnificent Hue Citadel, visit the royal tombs, and enjoy a traditional boat ride on the Perfume River.',
      duration: '3 days / 2 nights',
      price: '$200',
      hotelOptions: [
    ...
    5: {
      ...
      description:
        'Experience the vibrant culture and natural beauty of the Mekong Delta. Visit floating markets, explore local villages, and enjoy a delicious Mekong Delta lunch.',
    ...
    6: {
      ...
      description:
        'Explore the breathtaking Phong Nha-Ke Bang National Park, a UNESCO World Heritage Site. Discover stunning caves, go kayaking, and enjoy the pristine natural beauty of the region.',
      duration: '3 days / 2 nights',
      price: '$250',
      hotelOptions: [
    ...
    7: {
      ...
      description:
        "Combine the modern city of Da Nang with the charm of Hoi An. Explore Da Nang's beaches, bridges, and Dragon Bridge, and then visit the historic town of Hoi An.",
      duration: '4 days / 3 nights',
      price: '$300',
      hotelOptions: [
    ...
    8: {
      ...
      description:
        'Relax and rejuvenate on the pristine beaches of Nha Trang, a popular coastal city. Enjoy swimming, sunbathing, snorkeling, and diving.',
      duration: '3 days / 2 nights',
      price: '$200',
      hotelOptions: [
    ...
    9: {
      ...
      description:
        'Explore the stunning Mui Ne Sand Dunes, a unique landscape shaped by wind and sand. Go sandboarding, ride a quad bike, and enjoy the panoramic views.',
      duration: '2 days / 1 night',
      price: '$100',
      hotelOptions: [
  ...
  if (tour) {
    tourDetailsDiv.innerHTML = `
            ...
            <select id="airline">
                ${tour.flightOptions
                  .map(
                    (flight) => `<option value="${flight.airline}">${flight.airline} - ${flight.flightNumber}</option>`,
                  )
                  .join('')}
            </select>
            <select id="seat">
